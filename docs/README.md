...
- **[Architecture Overview](ARCHITECTURE.md)** - Nomad's modular architecture (Core, UI, Audio, Muse)
...
- **[License Reference](LICENSE_REFERENCE.md)** - Licensing information and commercial terms
...
4. Check [AI Guide](AI_GUIDE.md) if working with Muse integration

### For Project Managers
1. Review [Roadmap](ROADMAP.md) for project milestones
2. Check [License Reference](LICENSE_REFERENCE.md) for commercial terms
